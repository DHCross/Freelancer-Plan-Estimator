...
export const TEAM_ROSTER: TeamMember[] = [
  {
    id: "ironforge",
    name: "Ironforge Games",
    role: "Publisher — adventure modules & supplements (OSR-adjacent)",
    hourlyRate: 25,
    weeklyCapacity: 15,
    draftSpeed: 300,
    compileSpeed: 2000,
  ...
  {
    id: "thornwood",
    name: "Thornwood Press",
    role: "Indie publisher — setting sourcebooks & player supplements",
    hourlyRate: 22,
    weeklyCapacity: 10,
    draftSpeed: 250,
    compileSpeed: 1800,
  ...
  {
    id: "questcraft",
    name: "QuestCraft Creative",
    role: "Crowdfunding creator — one-shots & backer supplements",
    hourlyRate: 30,
    weeklyCapacity: 8,
    draftSpeed: 350,
    compileSpeed: 2500,
...
export const PRODUCT_LINES: ProductLine[] = [
  {
    id: "ironforge",
    label: "Ironforge Games",
    owner: "Ironforge Games",
    color: "#f97316",
    description: "Adventure modules and supplements for OSR-adjacent audiences.",
    productIds: [1, 2, 7],
  },
  {
    id: "thornwood",
    label: "Thornwood Press",
    owner: "Thornwood Press",
    color: "#3b82f6",
    description: "Setting sourcebooks and player supplements for indie TTRPG audiences.",
    productIds: [3, 4],
  },
  {
    id: "questcraft",
    label: "QuestCraft Creative",
    owner: "QuestCraft Creative",
    color: "#10b981",
    description: "Kickstarter backer rewards — one-shots and stretch-goal supplements.",
    productIds: [5, 6],
  },
];

export const INITIAL_PROJECTS: Project[] = [
  // Ironforge Games Projects
  {
    id: 1,
    name: "Shattered Vaults: Adventure Module",
  ...
  {
    id: 2,
    name: "Quickstart: The Iron Delve",
    type: "Small Adventure",
    clientType: "Marketing Hook",
    targetWords: 15000,
    assignedTo: "ironforge",
  ...
  {
    id: 7,
    name: "Iron Vaults Battlemaps Collection",
    type: "Battle Maps",
  ...
  // Thornwood Press Projects
  {
    id: 3,
    name: "The Verdant Frontier: Setting Sourcebook",
    type: "Setting Sourcebook",
    clientType: "Flagship Release",
    targetWords: 40000,
    assignedTo: "thornwood",
    internalStatus: "Planning",
    clientStatus: "Planned",
    stakeholder: "Thornwood Press",
    launchWindow: "Q3 2026",
  ...
  {
    id: 4,
    name: "Ranger's Field Guide: Player Supplement",
  ...
  // QuestCraft Creative Projects
  {
    id: 5,
    name: "Midnight Heist: One-Shot Adventure",
    type: "Small Adventure",
    clientType: "Kickstarter Reward",
    targetWords: 12000,
    assignedTo: "questcraft",
    internalStatus: "Drafting",
    clientStatus: "In Progress",
    stakeholder: "QuestCraft Creative",
    launchWindow: "Q2 2026",
  ...
  {
    id: 6,
    name: "Arcane Compendium: Spellcaster Supplement",
    type: "Player Sourcebook",
    clientType: "Stretch Goal",
    targetWords: 18000,
    assignedTo: "questcraft",
    internalStatus: "Planning",
    clientStatus: "Planned",
...
export const STAKEHOLDER_COLORS: Record<string, string> = {
  "Ironforge Games": "#f97316",
  "Thornwood Press": "#3b82f6",
  "QuestCraft Creative": "#10b981",
};
...
export const INCOME_SCENARIOS: IncomeScenario[] = [
  ...
  { id: "studio_push", label: "High-Earning Freelance Year", desiredIncome: 80000 },
];
...
export const CAPACITY_GAP_STATS = {
  ...
  gapHours: 1600,
  description:
    "Without additional investment, 2026 delivery slips by two quarters. Increasing your available hours or deferring lower-priority projects will close this gap.",
};

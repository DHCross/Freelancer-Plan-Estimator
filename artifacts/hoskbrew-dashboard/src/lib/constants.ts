...
export const PRODUCT_LINES: ProductLine[] = [
  ...
  },
  {
    ...
    owner: "Alex",
    color: "#10b981",
    description: "Scaffolding and system reliability that unblock the core series schedule.",
    productIds: [2, 3, 4, 5],
  },
];

export const INITIAL_PROJECTS: Project[] = [
  // Lead Author Product Line
  {
    id: 6,
    name: "Project Alpha: Launch Edition",
    ...
    dependency: "Core Series Framework",
  ...
  {
    id: 7,
    name: "Project A1: Core Release (Complete)",
    ...
    isLocked: false,
    budgetType: "Revenue Generator",
    dependency: "Project Alpha: Launch Edition",
  ...
  },
  {
    ...
    isLocked: false,
    budgetType: "Revenue Generator",
    dependency: "Project A1: Core Release",
  ...
  {
    id: 12,
    name: "Supplemental Maps Collection",
    type: "Battle Maps",
    clientType: "Revenue Accelerator",
    targetWords: 30000,
    assignedTo: "martin",
  ...
  {
    id: 15,
    name: "Project A2: Core Release Part 2",
    type: "Large Adventure",
    clientType: "Flagship Release",
    targetWords: 80000,
    assignedTo: "martin",
  ...
  {
    id: 16,
    name: "Project A3: Core Release Part 3",
    type: "Large Adventure",
    clientType: "Flagship Release",
    targetWords: 80000,
    assignedTo: "martin",
    ...
    isLocked: false,
    budgetType: "Revenue Generator",
    dependency: "Project A2: Core Release Part 2",
    revenuePotential: "Series Continuation",
    manualHours: 320,
    layoutHours: 200,
    lifecycleState: "Planning",
  ...
  {
    id: 17,
    name: "Project A4: Core Release Part 4",
    type: "Large Adventure",
    clientType: "Flagship Release",
    targetWords: 80000,
    assignedTo: "martin",
    ...
    isLocked: false,
    budgetType: "Revenue Generator",
    dependency: "Project A3: Core Release Part 3",
  ...
  {
    id: 14,
    name: "Core Ruleset (Skeleton Draft)",
    type: "Core Rules",
    ...
    dependency: "Core Series Success",
  ...
  // Publisher IP Product Line (Separate Pipeline)
  {
    id: 1,
    name: "Core IP: 2nd Edition Release",
  ...
  // Infrastructure Projects (Support Both Lines)
  {
    ...
    revenuePotential: "Unlocks Lead Author",
    lifecycleState: "Production",
    tasks: [{
      id: "task-2-1",
      projectId: 2,
  ...
  {
    id: 3,
    name: "Project Scaffolding Maintenance",
    type: "Lore/Structure",

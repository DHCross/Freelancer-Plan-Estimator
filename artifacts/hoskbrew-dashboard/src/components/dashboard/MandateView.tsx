  ...
  return (
    <div className="space-y-6">
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex items-center justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-slate-400">Client Projects</p>
          <h2 className="text-2xl font-bold text-slate-900">Project Roadmap</h2>
          <p className="text-sm text-slate-600 mt-2">
            Single source of truth for every active and queued project, with client, type, and target window.
          </p>
        </div>
